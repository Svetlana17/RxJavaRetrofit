...
public class MainActivity extends AppCompatActivity {
    ...
    private void callEndpoints() {
        ...
        Observable<List<Crypto.Market>> btcObservable = cryptocurrencyService.getCoinData("btc")
                ...
                //Observable<list<Marlet>>
                .flatMap(x -> x)//превратить Observable<list <Market>> кажый эл. списка в Observable<Market>
                // к-ый магазин становится производителем информациии о себе
                .filter(y -> {

                    y.coinName = "btc";//фильтр ильтр, магизирны  у которых поле name=btc
                    return true;
                }).toList().toObservable();//магазины поместить в список. Список  превратить в Observable<List<Crypto.Market>>
